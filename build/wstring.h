...
int wstring_put(wstring_t *wstring, wchar_t wc) {
	...
	wstring->size++;
	wstring->data[wstring->size] = NULL_CHAR;
...
int wstring_contains(const wstring_t *wstring, wchar_t wc) {
